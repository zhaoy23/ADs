...
class Augmenetor:
    def __init__(self,Normalize=False,MODELPATH="TFModles/"):
        ...
        normalize="_normalized" if Normalize else ""
        self.model.load_weights(MODELPATH+"WTK_Autoencoder"+normalize+"_weights.h5")
